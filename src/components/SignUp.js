...
function SignUp({ updateFormState, signUp, error }) {
  ...
  return (
    ...
    <div className='bg-red-300 shadow-md rounded px-8 pt-6 pb-8 mb-4'>
      ...
      <input className='shadow appearance-none border rounded w-full py-2 px-3 text-white-100  leading-tight focus:outline-none focus:shadow-outline'
        name='username'
